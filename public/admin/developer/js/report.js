...
////load the data......................................................
    dataTable = $('#table').DataTable({
        ...
        "ajax":{
            ...
            url : BASE_URL+'/admin/report/getReportData', // json datasource
            ...
            error: function(){  // error handling
                ...
                $("#table").append('<tbody class="user-table-error"><tr><th colspan="3">No data found in the server</th></tr></tbody>');
