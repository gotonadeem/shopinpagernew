...
dataTable = $('#order-table').DataTable({
    ...
    "ajax":{
        ...
        url : BASE_URL+'/admin/order/getOrderData', // json datasource
...
function get_reason(value)
{
	 $.ajax({
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
            url: BASE_URL+'/admin/order/view-reason',
            type: 'POST',
            data: {id: value },
            success: function (data) {
                $("#msg").html(data);
...
function get_exchange_details(value)
{
	 $.ajax({
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
            url: BASE_URL+'/admin/order/view-product-details',
            type: 'POST',
            data: {id: value },
            success: function (data) {
                $("#msg").html(data);
