...
////load the data......................................................
    dataTable = $('#section-table').DataTable({
        ...
        "ajax":{
            ...
            url : BASE_URL+'/admin/section/getSectionData', // json datasource
    ...
    $('.dataTables_filter input').attr("placeholder", "title");
    $('.dataTables_filter input').attr("class", "clearable");

///delete record...............................
function deleteItem(id){
    var result = confirm("Are you sure you want to delete the Faq Question ?");
    if (result) {
        $('#ajaxLoader').show();
        $.ajax({
            headers: {
            ...
            url: BASE_URL+'/admin/section/delete',
            type: 'POST',
            data: {id: id },
