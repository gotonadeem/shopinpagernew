...
////load the data......................................................
    dataTable = $('#datatable-fixed-header').DataTable({
        ...
        "ajax":{
            ...
            url : BASE_URL+'/admin/payment/getResellerPaymentData', // json datasource
    ...
    $('.dataTables_filter input').attr("placeholder", "email,mobile");
...
function change_status(id){
    ...
    if (result) {
        ...
        $.ajax({
            ...
            url: BASE_URL+'/admin/payment/update-reseller-payment-status',
            type: 'POST',
