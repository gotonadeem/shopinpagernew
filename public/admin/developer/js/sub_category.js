...
////load the data......................................................
dataTable = $('#subcategory-table').DataTable({
   pageLength: 25,        responsive: true,        dom: '<"html5buttons"B>lTfgitp',        buttons: [            {extend: 'copy'},            {extend: 'csv'},            {extend: 'excel', title: 'ExampleFile'},            {extend: 'pdf', title: 'ExampleFile'},            {extend: 'print',                customize: function (win){                    $(win.document.body).addClass('white-bg');                    $(win.document.body).css('font-size', '10px');                    $(win.document.body).find('table')                        .addClass('compact')                        .css('font-size', 'inherit');                }            }        ],
    "oLanguage": {
    ...
    "ajax":{
        ...
        url : BASE_URL+'/admin/subcategory/getSubCategoryData', // json datasource
...
function deleteItem(id){
    var result = confirm("Are you sure you want to delete the sub category ?");
    if (result) {
        $('#ajaxLoader').show();
        $.ajax({
            headers: {
            ...
            url: BASE_URL+'/admin/subcategory/delete/'+id,
            type: 'POST',
            data: {},
...
dataTable = $('#product-table').DataTable({
    ...
    "ajax":{
        ...
        url : BASE_URL+'/admin/subcategory/getProductBySubCategory', // json datasource
        type: "post",  // method  , by default get
		"data": function ( d ) {
