...
////load the data......................................................
    dataTable = $('#users-table').DataTable({
        ...
        "ajax":{
            ...
            url : BASE_URL+'/admin/getComplainUserData', // json datasource
...
dataTable = $('#list-table').DataTable({
    ...
    "ajax":{
        ...
        url : BASE_URL+'/admin/getRaisingComplaintData', // json datasource

        type: "post",  // method  , by default get
        error: function(){  // error handling
            $(".user-table-error").html("");
            $("#list-table").append('<tbody class="user-table-error"><tr><th colspan="7">No data found in the server</th></tr></tbody>');
            //$("#user-table_processing").css("display","none");
        }
    },
    "columnDefs": [ { orderable: false, targets: [0,5] }],
    ...
    dataTable = $('#order-table').DataTable({
       // pageLength: 25,
        ...
        "ajax":{
            ...
            url : BASE_URL+'/admin/customer/getOrderData', // json datasource
