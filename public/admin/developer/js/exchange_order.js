...
// exchange pending order......................................................
dataTable = $('#pending-exchange-order-table').DataTable({
    ...
    "ajax":{
        ...
        url : BASE_URL+'/admin/order/getExchangePendingOrderData', // json datasource
...
dataTable = $('#approved-exchange-order-table').DataTable({
    fixedHeader: true,  "dom": 'C<"clear">lfrtip',
    "colVis": {
        "buttonText": "View columns"
    },
    ...
    "ajax":{
        ...
        url : BASE_URL+'/admin/order/getExchangeApprovedOrderData', // json datasource
        type: "post",  // method  , by default get
        error: function(){  // error handling
            $(".user-table-error").html("");
            $("#users-table").append('<tbody class="user-table-error"><tr><th colspan="7">No data found in the server</th></tr></tbody>');
