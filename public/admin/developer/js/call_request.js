...
////load the data......................................................
dataTable = $('#call-request').DataTable({
    ...
    "ajax":{
        ...
        url : BASE_URL+'/admin/getCallRequestData', // json datasource
        type: "post",		
        error: function(){ 
...
function deleteItem(id){
    var result = confirm("Are you sure you want to delete this call request ?");
    if (result) {
        $('#ajaxLoader').show();
        $.ajax({
            headers: {
            ...
            url: BASE_URL+'/admin/call-request/delete',
            type: 'POST',
            data: {id: id },
            ...
            error: function () {
                console.log('There is some error in request deleting. Please try again.');
            }
        });
        return false;
    }
