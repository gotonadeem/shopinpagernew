/* ...Included script from:
Asynchronous gallery images script: https://codepen.io/Smackjax/pen/qwamXa
*/
...
const deleteActiveSlides = dir => {
  ...
  for (let q = 0; q < currentSlides.length; q++) {if (window.CP.shouldStopExecution(0)) break;
...
const intializeSlides = () => {
  ...
  for (let q = 0; q < imgSrcEls.length; q++) {if (window.CP.shouldStopExecution(1)) break;
