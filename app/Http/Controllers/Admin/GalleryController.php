...
class GalleryController extends Controller
{
 ...
 //get list of record of subadmin...........................................................
    public function getGalleryData(Request $request)
    {
        ...
        $totalItems = Gallery::get()->count();
        $totalFiltered = $totalItems;
        $items = Gallery::where('id','!=',0);
        ...
        foreach ($items as $item) {
            ...
            $nestedData[] = '<img src="' . URL::to('/') . '/public/admin/uploads/gallery_image/'.$img.'" height="100" width="150">';
    ...
    public function add_gallery()
    {
      ...
      return view('admin.gallery.create',compact('category_list'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            return redirect('admin/gallery/add-gallery')->withInput()->withErrors($validator);
        }else{
            $slider = new Gallery($request->all());

            //Upload Image
            $image = $request->file('image');
            //dd($image);
            $path_original=public_path() . '/admin/uploads/gallery_image';
                $file = $request->image;
        ...
        // redirect
        Session::flash('success_message', 'Your gallery has been added successfully');
        return redirect('/admin/gallery/gallery-list');
    }
    /**
     ...
     */
     ...
     {
        $data= GeneralSetting::select('message')->first();
        return view('admin.gallery.message')->with(['data'=>$data]);
     }
      ...
      public function message(Request $request)
      {
        ...
        if ($validator->fails())
        {
            return redirect('/admin/gallery/message')->withInput()->withErrors($validator);
        }
        else
        {
            $data=array();
            ...
            return redirect('/admin/gallery/message');
        }
    }
