...
class MerchantController extends Controller
{
    ...
    {  
        ...
        $users = User::select('*')->where('role_id',4)->where('verify_status','requested')->orderBy('id', 'desc');
        ...
        foreach ($users as $item) {
            ...
            $nestedData[] = date('d-m-Y', $date);
             ...
             if($item->banned==0){ $class="on"; $title="active"; } else { $class="off"; $title="inactive"; }
              ...
              $activateLink = '<a href="' . URL::to('/') . '/admin/merchant/update-status/'.$item->id.'" title="'.$title.'"><i class="fa fa-toggle-'.$class.'" aria-hidden="true" ></i></a>';
    ...
    //get list of record of subadmin...........................................................
    public function getActiveMerchantData(Request $request)
    {
	$requestData = $_REQUEST;
        $columns = array(
            // column index  => database column name
        ...
        $totalFiltered = $totalUsers;
        $users = User::select('*')->where('role_id',4)->where('verify_status','requested')->where('banned',0)->orderBy('id', 'desc');
        $searchString = str_replace("%", "zzempty", $requestData['search']['value']);
        $searchString = str_replace("'", "\'", $searchString);
        if (!empty($requestData['search']['value']))
        {
    ...
    //get list of record of subadmin...........................................................
    public function getinActiveMerchantData(Request $request)
    {
	$requestData = $_REQUEST;
        $columns = array(
            // column index  => database column name
        ...
        $totalFiltered = $totalUsers;
        $users = User::select('*')->where('role_id',4)->where('verify_status','requested')->where('banned',1)->orderBy('id', 'desc');
        $searchString = str_replace("%", "zzempty", $requestData['search']['value']);
        $searchString = str_replace("'", "\'", $searchString);
        if (!empty($requestData['search']['value']))
        {
    ...
    function view($id=null)
    {
        ...
        return view('admin.merchant.view')->with('user', $user)->with('id', $id);
    }
	...
	public function add()
    {
        ...
        return view('admin.merchant.add')->with('state_list',$state_list);
    }
    ...
    public function getNextNumber($value)
   {
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('success_message', 'Your merchant has been added successfully');
        return redirect('/admin/merchant/merchant-list');
    }
