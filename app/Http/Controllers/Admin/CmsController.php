...
class CmsController extends Controller
{
    ...
    public function getCmsData(Request $request)
    {
        ...
        foreach ($users as $item) {
            ...
            $editLink = '<a href="' . URL::to('/') . '/admin/cms/edit/' . $item->id . ' " title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>';
            $viewLink = '<a href="' . URL::to('/') . '/admin/cms/view/' . $item->id . ' " title="View"><i class="glyphicon glyphicon-eye-open"></i></a>';
            $nestedData[] = $editLink . " | " .$viewLink;
   ...
   function edit($id)
	 ...
	 public function update($id, Request $request)
    {
        ...
        if ($validator->fails())
        {
            return redirect('admin/cms/edit/'.$id)->withInput()->withErrors($validator);
        }
        else
        {
            $data=Input::all();
            $faq->fill($data)->save();
            // redirect
            Session::flash('success_message', 'Cms Successfully updated');
            return redirect('admin/cms/cms-list');
        }
