...
@section('content')
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h4 class="header-title m-t-0">Add Delivery charges ({{$city->name}})</h4>
                    </div>
                <!-- form start -->

                {{ Form::open(array('url' => 'admin/delivery/standard/'.$city->id,'class'=>'form-horizontal','enctype'=>'multipart/form-data','name'=>'add_package')) }}
                  ...
                  <div class="box-body">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-6">
                             <select name="type"  onchange="get_delivery('{{$city->id}}', this.value)" class="form-control">
                  ...
                  <div class="box-body">
                      <div class="form-group">
                          ...
                          <div class="col-md-6">
                              <input type="text" id="radius" name="radius" value="{{$data?$data->radius:''}}" class="form-control"  placeholder="Radius">
				  ...
				  <div class="box-body">
                      <div class="form-group">
                          ...
                          <div class="col-md-6">
                              <input type="text" id="radius_charge" name="radius_charge"  value="{{$data?$data->radius_charge:''}}" class="form-control"  placeholder="Radius Charge">
				  ...
				  <div class="box-body">
                      <div class="form-group">
                          ...
                          <div class="col-md-6">
                              <input type="text" id="out_of_radius_charge" name="out_of_radius_charge" value="{{$data?$data->out_of_radius_charge:''}}" class="form-control"  placeholder="Out Of Radius Charge">
				  ...
				  <div class="box-body">
                      <div class="form-group">
                          ...
                          <div class="col-md-6">
                              <input type="text" id="min_order" name="min_order" value="{{$data?$data->min_order:''}}" class="form-control"  placeholder="Min Order">
    ...
    <script language="JavaScript" type="text/javascript" src="{{ URL::asset('public/admin/developer/js/delivery_charges.js') }}"></script>
