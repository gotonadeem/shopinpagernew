            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        {{ Form::open(array('url' =>'admin/city/store','class'=>'form-horizontal','enctype'=>'multipart/puform-data','method'=>'post')) }}
                              <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-4 form-control-label">Enter Pincode<span class="text-danger">*</span> </label>
                                    <div class="col-sm-8">
                                         <input type="text" class="form-control" id="pincode" name="pincode">
                                        <div>Example:302001,325206,325204</div>
