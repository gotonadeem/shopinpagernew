...
@section('content')
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            ...
                            <h4 class="m-t-0 header-title"><b>List of Unpaid Users</b></h4>
    ...
    <script language="JavaScript" type="text/javascript" src="{{ URL::asset('public/admin/developer/js/unpaid_user.js') }}"></script>
