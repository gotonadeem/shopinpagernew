            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table id="user-complaints" class="table table-striped table-bordered table-hover dataTables-example">
                            <thead>
                            <tr>
                                <th>Sr.</th>
                                <th>User id</th>
...
<script language="JavaScript" type="text/javascript" src="{{ URL::asset('public/admin/developer/js/user_complaints.js') }}"></script>
<script>
