...
@section('content')
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            ...
                            <h4 class="m-t-0 header-title"><b>List of Team</b></h4>
                            <a href="{{ url('/admin/team/add-team') }}" class="btn btn-primary pull-right">Add Team</a>
    ...
    <script language="JavaScript" type="text/javascript" src="{{ URL::asset('public/admin/developer/js/team.js') }}"></script>
@stop
