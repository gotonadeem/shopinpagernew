            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h4 class="header-title m-t-0">Edit Coupon</h4>
                ...
                <!-- form start -->
                {{ Form::open(array('url' => 'admin/coupon/update/'.$coupon->id,'class'=>'form-horizontal','enctype'=>'multipart/form-data','name'=>'add_package')) }}
                  <div class="box-body">
                  ...
                  <div class="box-body">
                      <div class="form-group">
                          ...
                          <div class="col-md-6">
                              <input type="text" id="start_date" name="start_date" value="{{date('d-m-Y',strtotime($coupon->start_date))}}" class="form-control"  placeholder="Start Date">
                   ...
                   <div class="box-body">
                      <div class="form-group">
                          ...
                          <div class="col-md-6">
                              <input type="text" id="end_date" name="end_date" value="{{date('d-m-Y',strtotime($coupon->end_date))}}" class="form-control"  placeholder="End Date">
                   ...
                   <div class="box-body">
                      <div class="form-group">
                          ...
                          <div class="col-md-6">
                              <input type="text" name="discount_amount" value="{{$coupon->discount_amount}}" class="form-control"  placeholder="Discount amount">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-6">
                             <select class="form-control" name="discount_unit">
                                <option <?php if($coupon->percent=="percent") { echo "selected";} ?> name="percent">%</option>
                                <option <?php if($coupon->percent=="fixed") { echo "selected";} ?> name="fixed">Fixed</option>
                             </select>
                   ...
                   <div class="box-body">
                      <div class="form-group">
                          ...
                          <div class="col-md-6">
                              <input type="text" name="no_of_usage" value="{{$coupon->no_of_usage}}" class="form-control"  placeholder="No Of Usage">
                   ...
                   <div class="box-body">
                      <div class="form-group">
                          ...
                          <div class="col-md-6">
                              <input type="text" name="usage_per_user" value="{{$coupon->usage_per_user}}" class="form-control"  placeholder="Uses Per User">
                   ...
                   <div class="box-body">
                      <div class="form-group">
                          ...
                          <div class="col-md-6">
                              <input type="text" name="min_ord_amount" value="{{$coupon->min_ord_amount}}" class="form-control"  placeholder="Min order amount">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-6">
                            <select name="status" class="form-control">
                              <option <?php if($coupon->status==0) { echo "selected";} ?> value="0">InActive</option>
                              <option <?php if($coupon->status==1) { echo "selected";} ?> value="1">Active</option> 
                            </select>
