    ...
    margin-top: 29px;">
            <div class="container">
                ...
                <div class="row coin-add" style="background:#fff; padding:10px;">
                    <div class="col-sm-12">
                        <h4 class="header-title m-t-0">Add Gallery</h4>
                    </div>
                <!-- form start -->
                {{ Form::open(array('url' => 'admin/gallery/storeGallery','class'=>'form-horizontal','enctype'=>'multipart/form-data','name'=>'add_slider')) }}
                  <div class="box-body">
