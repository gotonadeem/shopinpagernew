...
@section('content')
    ...
    margin-top: 29px;">
            <div class="container">
                ...
                <!-- form start -->
                {{ Form::open(array('url' => 'admin/section/store-section','class'=>'form-horizontal','enctype'=>'multipart/form-data','name'=>'add_faq')) }}
                  <div class="box-body">
				     ...
				     <div class="form-group">
					  ...
					  <div class="form-group">
                          <label for="exampleInputEmail1" class="col-md-3 control-label">Image<span class="star_important">*</span></label>
                          <div class="col-md-6">
