            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <!-- form start -->
                    {{ Form::model($section,array('url' => ['admin/section/update/'.$section->id],'class'=>'form-horizontal','method'=>'post','enctype'=>'multipart/form-data')) }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    {{Form::textarea('description',empty($section->description) ? '' : $section->description,['class'=>'form-control','id'=>'title','placeholder'=>'Enter Description'])}}
