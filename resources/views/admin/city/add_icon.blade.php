    ...
    margin-top: 29px;">
            <div class="container">
                ...
                <div class="row coin-add" style="background:#fff; padding:10px;">
                    ...
                    <!-- form start -->
                    {{ Form::model($cityData,array('url' => 'admin/icon-store/'.$cityData->id, 'enctype'=>'multipart/form-data', 'class'=>'form-horizontal')) }}
                    <div class="box-body">
                    ...
                    <div class="box-footer">
                        ...
                        <div class="col-md-9">
                            ...
                            <a href="{{ URL::to('admin/city/index') }}" class="btn btn-info btn-sm" ><i class="fa fa-info"></i> Back</a>
                        </div>
                    </div>
                    {{ Form::close() }}
                </div> <!-- container -->
