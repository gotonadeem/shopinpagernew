            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
					...
					<div class="text-right">
                        <a href="{{ URL::to('admin/city/import') }}" class="btn btn-info">Import CSV</a> <a href="{{ URL::to('admin/city/create') }}" class="btn btn-info">Add New</a>
                    </div>
                    <div class="ibox-content">
                        <div class="table-responsive">
                                <table id="city-table" class="table table-striped table-bordered table-hover dataTables-example">
                                    <thead>
                                    <tr>
                                    <th>Sr.</th>
                                    <th>Name</th>
