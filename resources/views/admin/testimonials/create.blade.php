        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="text-right"><a href="{{ URL::to('admin/testimonials/testimonials-list') }}" class="btn btn-info">Back</a>
                        <div class="ibox-tools">
                        </div>
                    </div>
                    {{ Form::open(array('url' =>'admin/testimonial/store-testimonial','class'=>'form-horizontal','enctype'=>'multipart/form-data','method'=>'post')) }}
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea type="text" class="summernote" cols="50" rows="5" name="description" value="{{ old('description')}}" class="form-control"  placeholder="Enter Description"></textarea>
