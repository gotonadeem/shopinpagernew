    ...
    margin-top: 29px;">
            <div class="container-fluid">
                ...
                <div class="row coin-add" style="background:#fff; padding:10px;">
                    <div class="col-sm-12">
                        <h4 class="header-title m-t-0">Add Note ({{$user->email}}) </h4>
			   ...
			   <div class="row">
					@foreach($user_notes as $vs)
					<div class="col-lg-4">
                <div class="ibox float-e-margins">
                    <div class="ibox-title box-heading">
                        <h5 class="text-formate">{{str_replace("_"," ",$vs->heading)}} &nbsp;&nbsp;  </h5> <a class="pull-right" id="{{$vs->id}}" onclick="deleteItem(this.id)" href="javascript::void(0)"><i style="font-size: 22px;
