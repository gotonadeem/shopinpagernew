    ...
    margin-top: 29px;">
            <div class="container-fluid">
                ...
                <div class="row coin-add" style="background:#fff; padding:10px;">
                    <div class="col-sm-12">
                        <h4 class="header-title m-t-0">Add Note ({{$product->name}}) </h4>
						<a class="pull-right btn btn-primary" href="{{URL::to(URL::previous())}}">Back</a>
                    </div>
					
					
                <!-- form start -->
                {{ Form::open(array('url' => 'admin/product-note/storeNote','class'=>'form-horizontal','enctype'=>'multipart/form-data','name'=>'add_faq')) }}
                  <div class="box-body">
				    <input type="hidden" name="product_id" value="{{$product->id}}">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-6">
							  ...
							  <option value="product_blocked">Product is Blocked</option>
							  <option value="product_not_verified_yet">Product is not verified Yet</option>
			   ...
			   <div class="row">
					@foreach($product_notes as $vs)
					<div class="col-lg-4">
                <div class="ibox float-e-margins">
                    <div class="ibox-title box-heading">
                        <h5 class="text-formate">{{str_replace("_"," ",$vs->heading)}} &nbsp;&nbsp;  </h5> <a class="pull-right" id="{{$vs->id}}" onclick="deleteItemProduct(this.id)" href="javascript::void(0)"><i style="font-size: 22px;
