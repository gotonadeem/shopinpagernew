    ...
    margin-top: 29px;">
            <div class="container">
                ...
                <div class="row coin-add" style="background:#fff; padding:10px;">
                    <div class="col-sm-12">
                        <h4 class="header-title m-t-0">Edit Section</h4>
                    </div>
                <!-- form start -->
                {{ Form::open(array('url'=>['admin/help/updateHelp/'.$help->id],'class'=>'form-horizontal','enctype'=>'multipart/form-data','name'=>'add_faq')) }}
                  <div class="box-body">
				     ...
				     <div class="form-group">
                          ...
                          <div class="col-md-6">
                               <select name="language" class="form-control">
							     <option <?PHP if($help->language=="eng"){ echo "selected";} ?> value="eng">ENG</option>
							     <option <?PHP if($help->language=="hindi"){ echo "selected";} ?> value="hindi">HINDI</option>
							   </select>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-6">
                              <input type="text" name="title" value="{{ $help->title}}" class="form-control"  placeholder="Enter Name">
					  ...
					  <div class="form-group">
                          ...
                          <div class="col-md-6">
                                <input type="text" name="link" value="{{ $help->link}}" class="form-control"  placeholder="Enter Video Code">
