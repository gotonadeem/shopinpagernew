...
@section('content')
    ...
    margin-top: 29px;">
            <div class="container">
                ...
                <!-- form start -->
                {{ Form::open(array('url' => 'admin/slider/storeSlider','class'=>'form-horizontal','enctype'=>'multipart/form-data','name'=>'add_slider')) }}
                  <div class="box-body">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-7">
                              ...
                              <div class="error-message">{{ $errors->first('images') }}(width=1350px and height=500px)</div>
