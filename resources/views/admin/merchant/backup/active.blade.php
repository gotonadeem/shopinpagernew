...
@section('content')
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
					...
					<div class="text-right"><a href="{{ URL::to('admin/merchant/create-merchant') }}" class="btn btn-info">Add New</a>
                    ...
                    <div class="ibox-content">
                        <div class="table-responsive">
                                <table id="active-table" class="table table-striped table-bordered table-hover dataTables-example">
                                    <thead>
                                    <tr>
                                    <th>Sr.</th>
                                    <th>Username</th>
    ...
    <script language="JavaScript" type="text/javascript" src="{{ URL::asset('public/admin/developer/js/merchant.js') }}"></script>
	<script>
