    ...
    margin-top: 29px;">
            <div class="container">
                ...
                <div class="row coin-add" style="background:#fff; padding:10px;">
                    <div class="col-sm-12">
                        <h4 class="header-title m-t-0">Add Package</h4>
                    </div>
                <!-- form start -->
                {{ Form::open(array('url' => 'admin/packages/storePackage','class'=>'form-horizontal','enctype'=>'multipart/form-data','name'=>'add_package')) }}
                  <div class="box-body">
                      <div class="form-group">
                          <label for="exampleInputEmail1" class="col-md-3 control-label">Package Name<span class="star_important">*</span></label>
                          <div class="col-md-6">
                      ...
                      <div class="form-group">
                          <label for="exampleInputEmail1" class="col-md-3 control-label">Price<span class="star_important">*</span></label>
                          <div class="col-md-6">
