                                ...
                                <div class="input_fields_wrap">
                                    <div class="input-box-unit">
                                        <div class="input-unit col-md-3">
                                            <input type="text" name="weight[]" placeholder="weight" value="<?=$vs->weight?>" class="form-control weight" {{$disabled}}>
                                        </div>
                                        <div class="input-unit col-md-3">
                                            <input type="text" placeholder="price" name="price[]" value="<?=$vs->price?>" class="form-control price" {{$disabled}}>
                                        </div>
                                        <div class="input-unit col-md-3">
                                            <input type="text" class="form-control sprice" name="sprice[]" value="<?=$vs->sprice?>" placeholder="Special Price" {{$disabled}}>
                                        </div>
                                        <div class="input-unit col-md-3">
                                            <input type="text" class="form-control qty" name="qty[]" value="<?=$vs->qty?>" placeholder="Qty" {{$disabled}}>
                                        </div>
