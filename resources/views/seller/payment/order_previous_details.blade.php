...
<div class="panel panel-default">
  <div class="page-header page-header-custom">
    ...
    <tbody>
      ...
      <tr>
        <td>Shopinpager Commission</td>
        <td class="error">-<i class="fa fa-inr" aria-hidden="true"></i><span>  
		...
		<?PHP
                ...
                $tcs_amount = ($netAmount * 1)/100;//tcs tax 1% on net amount.
       ...
       <tr>
        ...
        <td class="border-top"><i class="fa fa-inr" aria-hidden="true"></i><span><b>{{round($sum-$admnTtlAmnt,2)}} </b></span></td>
      </tr>
    </tbody>
  </table>
  </div>
