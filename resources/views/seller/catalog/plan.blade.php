      ...
      <div class="modal-body">
				  <div class="col-md-4">
					  <div class="purchase-tag">
					   ...
					   <span class="price-amount"><i class="fa fa-inr" aria-hidden="true"></i><?PHP echo $sponsor_plan[0]['price'] ?></span>
				  ...
				  <div class="col-md-4">
					   ...
					   <span class="price-amount"><i class="fa fa-inr" aria-hidden="true"></i> <?PHP echo $sponsor_plan[1]['price'] ?></span>
					   <div class="radio-box-custom">
				     ...
				     <div class="col-md-4">
					  <div class="purchase-tag">
					   ...
					   <span class="price-amount"><i class="fa fa-inr" aria-hidden="true"></i> <?PHP echo $sponsor_plan[2]['price'] ?></span>
					   <div class="radio-box-custom">
