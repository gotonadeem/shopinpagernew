...
<div id="rightSidenav" class="right_side_bar">
	...
	<div> @if(Session::has('success_message'))
        ...
        <div class="tab inventory">
            <button class="tablinks" onclick="openTab(event, 'instok')" id="defaultOpen">In Stock</button>
            <a href="{{URL::to('seller/out-of-stock')}}"><button class="tablinks" >Out Of Stock</button></a>
        </div>
        <div id="instok" class="tabcontent">
            <div class="stock_head">
				...
				<div class="catalog-container box-shadow inventry-custom">
                    ...
                    <div class="catalog-content padding-10">
                        <div class="catalog-name padding-5 text-center bold font-16">{{ $vs->name}}({{$vs->count}})</div>
                     </div>
                     </div>
                     <div class="row">
                     <div class="col-md-12">
                    <div class="catalog-action">
                        <a class="button-color-2 inventory-button display-block" href="{{URL::to('/seller/product-by-category')}}/{{ $vs->id}}">View Products</a>
