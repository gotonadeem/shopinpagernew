...
<div id="rightSidenav" class="right_side_bar">
    <div class="tab">
        ...
        <a class="focus" href="{{URL::to('seller/return-order')}}"><button class="tablinks">Return</button></a>
    ...
    <div id="shipped" style="display:block" class="tabcontent">
        ...
        <div class="group-view relative">
            <div class="group-view-button clearfix"><a href="https://s3-ap-southeast-1.amazonaws.com/meesho-supply-v2/labels/7633447/16bc2aeae65e0997f9ec7589c999ec3bfc0fb9c1.pdf" target="_blank" class="printLabelLink button-shadow"><i class="fa fa-download" aria-hidden="true"></i><!-- react-text: 171 -->Label<!-- /react-text --></a>
                    ...
                    <div class="group-suborders">
                        <div class="group-suborder">
                            <div class="flex-container clearfix border relative">
								...
								<?PHP 
								foreach(Helper::get_order_image($vs->order_id,Auth::user()->id,'return') as $ks=>$image):
								?>
                               ...
                               <?PHP endforeach; ?> 
								...
								<div class="order-product-info">
                                    ...
                                    <div class="order-div"><label>Number Of Products :</label> <span><?=Helper::get_number_of_product_by($vs->order->id,Auth::user()->id,'return');?></span></div>
                                    <div class="order-div"><label>Total Amount :</label> <span>{{$vs->amount}} Rs.</span></div>
                                    <div class="qty"><label>Qty:</label> <span><?=Helper::get_number_of_qty($vs->order->id,Auth::user()->id,'return');?></span></div> 
